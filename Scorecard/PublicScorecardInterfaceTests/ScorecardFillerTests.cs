...
namespace PublicScorecardInterfaceTests
{
    ...
    public class ScorecardFillerTests
    {
        ...
        {
            ScorecardFiller filler = new ScorecardFiller();
            VolleyballMatch match = new VolleyballMatch(filler);
            
            filler.SetTeams("Home Team","Guest Team");
            ...
            Assert.AreEqual(1, filler.VolleyballMatch.SetsOfTheMatch[1].HomePoints);
